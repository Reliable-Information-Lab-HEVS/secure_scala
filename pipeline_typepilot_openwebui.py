...
class Pipe:
    ...
    def create_final_prompt_vulnerabilities(self, task, previous_code, vulnerabilities):
    ...
    def pipes(self):
        ...
        name = f"TypePilot, model: {self.valves.MODEL}"
    ...
    async def pipe(
        ...
        try:
            ...
            await self.set_file(
                "https://raw.githubusercontent.com/AlexanderSternfeld/images/refs/heads/main/stage0_exo.gif",
                __event_emitter__,
            )
            ...
            await self.set_file(
                "https://github.com/AlexanderSternfeld/images/blob/main/stage1_exo.gif?raw=true",
                __event_emitter__,
            )
            ...
            await self.set_status(
                "Using the Scala type system to address vulnerabilities...",
                __event_emitter__,
            )
            await self.set_file(
                "https://raw.githubusercontent.com/AlexanderSternfeld/images/refs/heads/main/stage2_exo.gif",
                __event_emitter__,
            )
            final_prompt = self.create_final_prompt_vulnerabilities(
            ...
            await self.set_file(
                "https://raw.githubusercontent.com/AlexanderSternfeld/images/refs/heads/main/final_exo.png",
                __event_emitter__,
            )
